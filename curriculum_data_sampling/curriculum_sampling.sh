...
python curriculum_data_sampling/curriculum_sampling.py \
--model "K-intelligence/Midm-2.0-Base-Instruct" \
--save_path "data/preprocessed/curriculum_sampling_results_선다형_단답형_Midm-2.0-Base-Instruct.csv" \
--training_data_path 'data/preprocessed/grpo_train_excluded_서술형.csv' \
