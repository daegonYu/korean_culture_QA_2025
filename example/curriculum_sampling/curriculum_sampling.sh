...
python scripts/convert_test_format/curriculum_sampling.py \
--model "trillionlabs/Tri-7B" \
--training_data_path '/workspace/korean_culture_QA_2025/data/preprocessed/original_train_excluded_서술형.csv' \
--save_path "data/preprocessed/curriculum_sampling_results_선다형_단답형_trillion-7B.csv" \
...
# python scripts/convert_test_format/curriculum_sampling.py \
# --model "trillionlabs/Tri-7B" \
# --training_data_path '/workspace/korean_culture_QA_2025/data/preprocessed/original_dev_excluded_서술형.csv' \
# --save_path "data/preprocessed/curriculum_sampling_results_선다형_단답형_dev_trillion-7B.csv" \
# --system_prompt "$system_prompt" \
# --user_prompt "$user_prompt"